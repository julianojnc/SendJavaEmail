...
public class SendMailTLS {
    ...
    public static void main(String[] args) {
        ...
        *APÓS A VERIFICAÇÃO EM DUAS ETAPAS, NO CASO DO GOOGLE NO MESMO LOCAL SERÁ MOSTRADO UM NOVO CAMPO CHAMEDO "SENHAS DE APP"
        *NO CAMPO MENCIONADO SERÁ POSSÍVEL ESTAR GERANDO UM SENHA DE APP, APÓS GERAR ADD NA VARIAVEL >PASSWORD<
        *LEMBRANDO DE ADD O EMAIL NA VARIAVEL >USERNAME<
        *ALTERE TAMBEM O EMAIL QUE IRA RECEBER A MENSAGEM E ALTERE TAMBEM A MENSAGEM
         */
